...
import ru.ideaplatform.testcase.utils.DataTimeConverter;
...
public class Ticket {
    ...
    public void setDepartureDateTime() {
        this.departureDateTime = DataTimeConverter.convertToLocalDateTime(departureDate, departureTime);
    }
    ...
    public void setArrivalDateTime() {
        this.arrivalDateTime = DataTimeConverter.convertToLocalDateTime(arrivalDate, arrivalTime);
    }
